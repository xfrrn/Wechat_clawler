...
from storage import persist_session, append_json_result  # <--- 修改这一行
...
def get_article_list(wx_cfg, fakeid, begin=0, count=5):
    """
    ...
    try:
        ...
        data = resp.text
    append_json_result("appmsgpublish_result.json", data)
    return data


def extract_title_url(
    input_file="appmsgpublish_result.json", output_file="title_url_map.json"
):
    """
